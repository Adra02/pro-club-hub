...
async function loadSharedProfile() {
    try {
        ...
        // Formato: /share.html?type=player&id=XXX
        ...
        if (!type || !id) {
            showError(
                ...
                'Assicurati di aver copiato l\'intero link.'
            );
            return;
        }
        ...
        showError(
            ...
            'Il profilo potrebbe essere stato eliminato o il link non è più valido.'
        );
    }
}
...
function renderPlayerProfile(data) {
    ...
    mainContent.innerHTML = `
        ...
        <div class="share-actions">
            ...
            <a href="https://pro-club-hub.com" class="btn-share">
...
function showError(title, message, details) {
    ...
    mainContent.innerHTML = `
        <div class="error-container">
            ...
            ${details ? `<p style="color: #64748b; margin-bottom: 30px;">${escapeHtml(details)}</p>` : ''}
            <a href="https://pro-club-hub.com" class="btn-home">
                <i class="fas fa-home"></i>
                Torna alla Home
            </a>
        </div>
